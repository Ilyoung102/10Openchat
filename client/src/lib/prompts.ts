...
export const SERVICE_DATA: ServiceCategory[] = [
  ...
  },
  {
    ...
    label: '영어 학습',
    items: [
      { id: 'cafe', icon: '☕', label: 'Cafe', prompt: 'Cafe 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'phone', icon: '📞', label: 'Phone', prompt: 'Phone 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'travel', icon: '🧳', label: 'Travel', prompt: 'Travel 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'work', icon: '💼', label: 'Work', prompt: 'Work 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'hotel', icon: '🏨', label: 'Hotel', prompt: 'Hotel 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'airport', icon: '🛫', label: 'Airport', prompt: 'Airport 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'hospital', icon: '🏥', label: 'Hospital', prompt: 'Hospital 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'restaurant', icon: '🍴', label: 'Restaurant', prompt: 'Restaurant 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'shopping', icon: '🛒', label: 'Shopping', prompt: 'Shopping 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'business', icon: '📈', label: 'Business', prompt: 'Business 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'emergency', icon: '🆘', label: 'Emergency', prompt: 'Emergency 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'street', icon: '🚶', label: 'Street', prompt: 'Street 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'chatter', icon: '💬', label: 'Chatter', prompt: 'Chatter 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'topic', icon: '📝', label: 'Topic', prompt: 'Topic 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
      { id: 'general', icon: '🌐', label: 'General', prompt: 'General 관련된 상황에 맞게 상황극 영어 대화를 4~7문장으로 기승전결이 자연스럽게 연결되는 상황극 3개를 이전과 다르게 만들어 주세요.' + ENGLISH_INSTRUCTION },
